...
[Stage 1] Context Extraction
  NotebookLM (CV, 포트폴리오, 프로젝트기술서, 논문)
        │
        ▼
  Structured Context (기술스택, 경험, 성과, 강점)
        │
        ▼
[Stage 2] Career Description & Essay
        │
        ├──▶ 상세 경력 기술서 (chronological)
        └──▶ 인사 관점 에세이 (collaboration, soft skills)
              │
              ▼
[Stage 3] Cover Letter Writing (Multi-Agent Loop)
  User Input (자소서 항목 + JD + 강조사항)
        │
        ▼
   ┌─────────┐     ┌───────────┐
   │  Writer  │────▶│  Reviewer  │
